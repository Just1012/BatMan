            ...
            columns: [{
...

                {
                    ...
                    render: function(data) {
                        // Replace the placeholder in the delete URL with the actual user ID
                        var deleteUrl = '{{ route('user.delete', ':id') }}';
                        deleteUrl = deleteUrl.replace(':id', data.id);

                        // Replace the placeholder in the edit URL with the actual user ID
                        var editUrl = '{{ route('user.edit', ':id') }}';
                        editUrl = editUrl.replace(':id', data.id);

                        // Return the HTML for both the edit and delete buttons
                        return `
                            <a href="${editUrl}" class="btn btn-warning"><i class="bx bxs-edit"></i></a>
                            <a href="${deleteUrl}" class="btn btn-danger"><i class="bx bxs-trash"></i></a>
                        `;
                    }
                },
